db.define_table("papyri",
	...
	Field("heid_inv_cat", type="string", label="Inventarisierung: Kategorie (Papyrus/Ostrakon)", length="1"),
	Field("heid_inv_spr", type="string", label="Inventarisierung: Sprache", length="64"),
	Field("heid_inv_nr", type="integer", label="Inventarisierung: Nummer", length="16"),
	Field("heid_inv_buchstabe", type="string", label="Inventarisierung: Buchstabe", length="128"),
	Field("heid_inv", type="string", label="Inventarisierung: Buchstabe", length="128"),
...
db.define_table("seiten",
	...
	Field("zusammensetzung_info", type="string", label="Infos zur Zusammensetzung"),
